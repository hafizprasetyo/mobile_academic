...
import 'package:academic/screens/lessons/lesson_detail_books.dart';
...
class ClassroomDetailBook extends StatefulWidget {
  const ClassroomDetailBook({Key? key, required this.classroom})
      : super(key: key);

  final Map<String, dynamic> classroom;

  @override
  _ClassroomDetailBookState createState() => _ClassroomDetailBookState();
}

class _ClassroomDetailBookState extends State<ClassroomDetailBook> {
  ...
  Future _gotoLessonDetail({required int id}) async {
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _lessonCard(
                    lesson: item,
                    onTap: () async => _gotoLessonDetail(id: item['id']),
                  );
                },
              ),
            )
