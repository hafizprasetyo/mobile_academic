...
import 'package:academic/screens/playground/default_exam.dart';
import 'package:academic/screens/playground/quiz_exam.dart';
...
class ClassroomDetailSimulation extends StatefulWidget {
  const ClassroomDetailSimulation({
    Key? key,
  ...
  @override
  _ClassroomDetailSimulationState createState() =>
      _ClassroomDetailSimulationState();
}

class _ClassroomDetailSimulationState extends State<ClassroomDetailSimulation> {
  ...
  Future _gotoPlayground({required int id}) async {
    ...
    try {
      ...
      if (lesson['stateMode'] == 'questiontest') {
        return Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => DefaultExam(
              classroom: _classroom,
              lesson: lesson,
            ),
          ),
        );
      } else if (lesson['stateMode'] == 'quiztest') {
        return Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => QuizExam(
